...
import com.example.loans.repositories.LoansRepository;
...
public class LoansServiceImpl implements  ILoansService {
    ...
    public boolean updateLoan(LoansDto loansDto) {
        ...
        // LoansDTO -----> LoansObject
        LoansMapper.mapToLoans(loansDto, loans);
        // As loans already have LoanId primary Key so it will not create a new object in db it will update the record
